...
export class ApplicantFormComponent implements OnInit {
  ...
  successMessage = '';
  errorMessage = '';
  jobId: string = ''; // To store the route parameter
  ...
  constructor(
    ...
    this.applicantForm = this.fb.group({
      ...
      address: [''],
      city: [''],
      appliedJobId: [''], // Add this field to your form
      resume: [null]
    });
  }

  ngOnInit(): void {
    // Get the route parameter when component initializes
    this.route.params.subscribe(params => {
      this.jobId = params['id'];
      // Set the value in the form
      this.applicantForm.patchValue({
        appliedJobId: this.jobId
      });
    });
  }
